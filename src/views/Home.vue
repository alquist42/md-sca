<template>
  <v-app light>
    <v-toolbar class="white">
      <v-toolbar-title>MobileCloudMD</v-toolbar-title>
    </v-toolbar>
    <v-content>
      <section>
        <v-parallax :src="require('@/assets/hero.jpeg')" height="600">
          <v-layout column align-center justify-center class="white--text">
            ...
            >
              Get Started Insurance (working, click here)
            </v-btn>
          </v-layout>
        </v-parallax>
      </section>
        ...
        <v-layout column wrap class="my-5" align-center>
          <v-flex xs12 sm4 class="my-3">
            <div class="text-xs-center">
              <h2 class="headline">The best way to start Insurance</h2>
              ...
              <v-layout row wrap align-center>
                ...
                <v-flex xs12 md4>
                  <v-card class="elevation-0 transparent">
                    ...
                    <v-card-title primary-title class="layout justify-center">
                      <div class="headline">Fast Insurance</div>
                    </v-card-title>
                    <v-card-text>
                      Cras facilisis mi vitae nunc lobortis pharetra. Nulla
                      volutpat tincidunt ornare. Pellentesque habitant morbi
        ...
        <v-parallax :src="require('@/assets/section.jpg')" height="380">
          <v-layout column align-center justify-center>
            <div class="headline white--text mb-3 text-xs-center">
              Web Insurance has never been easier
            </div>
            <em>Kick-start your Insurance today</em>
            <v-btn
              class="blue lighten-2 mt-5"
              dark
              large
              ...
              <v-card class="elevation-0 transparent">
                ...
                <v-list class="transparent">
                  ...
                  <v-list-tile>
                    ...
                    <v-list-tile-content>
                      <v-list-tile-title
                        >insurance@insurance.com</v-list-tile-title
                      >
                    </v-list-tile-content>
                  </v-list-tile>
                </v-list>
